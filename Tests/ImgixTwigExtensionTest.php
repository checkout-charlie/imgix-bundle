...
class ImgixExtensionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTwigCalls()
    {
        ...
        $imgixServiceMock->expects($this->exactly(1))->method('transformHtml')->with('html', ['p7' => 7], ['p8' => 8])->willReturn('transformHtmlCalled');
        ...
        $this->assertEquals('transformHtmlCalled', $container->get(ImgixTwigExtension::class)->transformHtml('html', ['p7' => 7], ['p8' => 8]));
